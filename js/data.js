 ...
 * Terri Donegan-Sanchez where to actually go before Team Member 8's stop
 * there.
 */
...
const STOPS = [
  ...
  // ---- EJ — University City (5 -- one tight cluster, kept whole) ----
  ...
  // ---- LaPaul — Matthews / Mint Hill + Independence (3) ----
  ...
  // ---- Joe — South Charlotte (South Meck / Providence / Ballantyne Ridge) (3) ----
  ...
  { id: "ballantyne-ridge-hs", school: "Ballantyne Ridge HS", address: "4004 Toringdon Way, Charlotte, NC 28277", contact: "Katherine Fisher", email: "katherineb.fisher@cms.k12.nc.us", hours: "7:15a-2:15p", zone: "South Charlotte", member: "joe", day: "day2", start: "7:15a", end: "9:00a" },

  // ---- Jackie — Ballantyne core (3) ----
  ...
  { id: "wilson-stem-academy", school: "Wilson STEM Academy", address: "7020 Tuckaseegee Rd, Charlotte, NC 28214", contact: "Tangee Kizer", email: "tangeeb.kizer@cms.k12.nc.us", hours: "8:45a-4:15p", zone: "West Charlotte/Uptown", member: "tm7", day: "day2", start: "8:45a", end: "10:30a" },
];
